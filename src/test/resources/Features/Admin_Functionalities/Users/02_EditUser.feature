...
Feature: Admin Edit User Functionality
  ...
  Scenario: BUG: US16_TC005 Verify error when name is empty
    ...
    And Admin Clicks Submit Button
    Then BUG: system restored old value instead of showing error "The name field is required."
    And admin updates name to ""
    And Admin Clicks Submit Button
    Then system should display error message "The name field is required."
  ...
  Scenario: BUG: US16_TC006 Verify error when email is empty
    ...
    And admin enters Password Confirmation "Diyala12"
    And Admin Clicks Submit Button
    Then BUG: system restored old value instead of showing error "The email field is required."
    And admin updates email to ""
    And Admin Clicks Submit Button
    Then system should display error message "The email field is required."
    And verify user with name "Diyala" and email "Diyala@example" is not updated in API
  ...
  Scenario: BUG: US16_TC007 Verify system accepts empty password
    ...
    And admin enters Password Confirmation "Diyala12"
    And Admin Clicks Submit Button
    Then System Should display error message "The password field is required"
  ...
  Scenario: BUG: US16_TC008 Verify system accepts empty confirm password
    ...
    And Admin Clicks Submit Button
    Then System Should display error message "Password confirmation does not match."
    And Verify user update "Diyala@example" in API with invalid data
  ...
  Scenario: BUG: US16_TC009 Verify error when role is null
    ...
    And admin enters Password Confirmation "Diyala12"
    And Admin Clicks Submit Button
    Then BUG: system restored old value instead of showing error "The role field is required."
    And admin updates email to "sara12@test.com"
    And Admin Clicks Submit Button
    Then system should display error message "The role field is required."
  ...
  Scenario: BUG: US16_TC010 Verify system accepts weak password
    ...
    And Admin Clicks Submit Button
    Then System Should display error message "The password must be at least 6 characters."
  ...
  Scenario: BUG: US16_TC011 Verify error for duplicate email
    ...
    And admin enters Password Confirmation "123"
    And Admin Clicks Submit Button
    Then BUG: system restored old value instead of showing error "The email has already been taken."
    And admin updates email to "sara12@test.com"
    And Admin Clicks Submit Button
    Then system should display error message "The email has already been taken."
